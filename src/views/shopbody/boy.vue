<template>
    <div class="shop-boy">
        <div class="tit">
            ...
            <div class="shop-tit">男的/{{shops.length}}件商品</div>
            </el-divider>
        </div>
        <div class="shopList">
            <div class="shop-category">
                <div class="shop-type">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:void(0)" @click="settype('足球')">足球</a></li>
                        <li><a href="javascript:void(0)" @click="settype('跑步')">跑步</a></li>
                        <li><a href="javascript:void(0)" @click="settype('休闲')">休闲</a></li>
                    </ul>
                </div>
            </div>
            <div class="type">类别:
...
export default {
    ...
    methods:{
        settype(data){
            ...
            that.shoptype = data
            that.shops = [];
            axios.get("/Finaltest1/ProductServlet?method=selbyptype&ptype="+that.shoptype+"&ptype2=男的").then(res=>{
                that.shops = res.data;
            });
        },
        clickshop(shop){
